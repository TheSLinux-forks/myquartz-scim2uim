...
;;
;; This table is generated from the original table from the branch `v3`.
;; Once this table is manually edit, the generator must be disabled and
;; any further udpate must be done carefully.
;;
;; Copyright (c) 2008 - 2010 Thach-Anh Tran
;; Copyright (c) 2013 Ky-Anh Huynh
;;
;; This work is part of `TheSLinux` distribution.
